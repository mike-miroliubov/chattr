 ...
 */
class ClientActor(context: ActorContext[ClientActor.Command], outboundQueue: SourceQueueWithComplete[OutgoingMessage], userId: String) extends AbstractBehavior[ClientActor.Command](context) {
